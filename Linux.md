...
- `scp`命令
  ...
  - security copy， linux 系统下基于ssh登陆进行安全的远程文件拷贝命令。
...
>more 指令是一个基于 VI 编辑器的**文本过滤器**，它以全屏幕的方式按页显示文本文件的内容。more 指令中内置了若干快捷键，详见操作说明。

基本语法：`more 要查看的文件`

操作说明：<img src="Linux.assets/image-20220717141725955.png" alt="image-20220717141725955" style="zoom:80%;" />
